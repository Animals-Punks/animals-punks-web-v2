        ...
        <ElementBox backgroundColor="#828282">
            ...
            <div css={titleTextStyle}>TEAM MEMBERS</div>
                <div css={sliderContainer}>
                    ...
                    >
                        <div>
                            <Image src={po0} width="100vw" height="100vh" />
                        ...
                        <div>
                            <Image src={pix} width="100vw" height="100vh" />
                        ...
                        <div>
                            <Image src={depp} width="100vw" height="100vh" />
                        ...
                        <div>
                            <Image src={wow} width="100vw" height="100vh" />
